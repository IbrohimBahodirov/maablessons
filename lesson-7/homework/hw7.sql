...
FirstName VARCHAR(50) NULL, LastName VARCHAR(50) NULL,
 DepartmentName VARCHAR(50), Salary DECIMAL(10, 2),
...
LastName VARCHAR(100), Email VARCHAR(100), Phone VARCHAR(50), Address VARCHAR(255), 
...
-- Insert 40 orders
INSERT INTO Orders VALUES (1, 1, 2, '2023-05-14', 1, 800.00), (2, 1, 3, '2024-09-07', 2, 800.00),
...
INSERT INTO Sales (SaleID, ProductID, CustomerID, SaleDate, SaleAmount) VALUES (1, 1, 1, '2023-01-01', 150.00),
 (2, 2, 2, '2023-01-02', 200.00), (3, 3, 3, '2023-01-03', 250.00),
  (4, 4, 4, '2023-01-04', 300.00), (5, 5, 5, '2023-01-05', 350.00),
   (6, 6, 6, '2023-01-06', 400.00), (7, 7, 7, '2023-01-07', 450.00),
    (8, 8, 8, '2023-01-08', 500.00), (9, 9, 9, '2023-01-09', 550.00),
     (10, 10, 10, '2023-01-10', 600.00), (11, 1, 1, '2023-01-11', 150.00), 
     (12, 2, 2, '2023-01-12', 200.00), (13, 3, 3, '2023-01-13', 250.00),
      (14, 4, 4, '2023-01-14', 300.00), (15, 5, 5, '2023-01-15', 350.00),
       (16, 6, 6, '2023-01-16', 400.00), (17, 7, 7, '2023-01-17', 450.00),
        (18, 8, 8, '2023-01-18', 500.00), (19, 9, 9, '2023-01-19', 550.00),
         (20, 10, 10, '2023-01-20', 600.00), (21, 1, 2, '2023-01-21', 150.00),
          (22, 2, 3, '2023-01-22', 200.00), (23, 3, 4, '2023-01-23', 250.00),
           (24, 4, 5, '2023-01-24', 300.00), (25, 5, 6, '2023-01-25', 350.00),
            (26, 6, 7, '2023-01-26', 400.00), (27, 7, 8, '2023-01-27', 450.00), 
            (28, 8, 9, '2023-01-28', 500.00), (29, 9, 10, '2023-01-29', 550.00),
             (30, 10, 1, '2023-01-30', 600.00), (31, 1, 2, '2023-02-01', 150.00),
              (32, 2, 3, '2023-02-02', 200.00), (33, 3, 4, '2023-02-03', 250.00),
               (34, 4, 5, '2023-02-04', 300.00), (35, 5, 6, '2023-02-05', 350.00), 
...
--task3
select count(*) as  thenumberofrows from Customers

--task4
select (COUNT(DISTINCT Category)) as  thenumberofrows from Products
...
--task9
select sum(CustomerID) sumCustomer from Sales
...
--Medium-Level Tasks
--task11
select ProductID ,count(SaleAmount) as countSA,AVG(SaleAmount) as avgSA from Sales 
group by ProductID

--task12
select count(DepartmentName) as countHR from  Employees 
where DepartmentName='HR'

--task13
select DepartmentName, max(Salary) as maxPrice,min(Salary) as minPrice from Employees
group by DepartmentName
...
--task15
select DepartmentName,count(*) as countEmployee,AVG(Salary) as avgSalary from Employees
group by DepartmentName
...
--task21
select CustomerID,sum(SaleAmount) as sumSaleAmount from Sales group by CustomerID
having sum(SaleAmount)>1500

--task22
select DepartmentName, sum(Salary), avg(Salary) from Employees group by DepartmentName
...
--task25
SELECT YEAR(OrderDate) AS SaleYear, min(Quantity) minQuantity ,
max(Quantity) as maxQuntity
FROM Orders
